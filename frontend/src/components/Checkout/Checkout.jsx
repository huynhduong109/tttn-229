  ...
  return (
    <div className="w-full flex flex-col items-center py-8">
      ...
      <div
        ...
        <h5 className="text-white">Đến trang thanh toán</h5>
      </div>
    </div>
  );
};
...
const ShippingInfo = ({
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      <h5 className="text-[18px] font-[500]">Thông tin vận chuyển</h5>
      <br />
      <form>
        <div className="w-full flex pb-3">
          <div className="w-[50%]">
            <label className="block pb-2">Tên người mua</label>
            <input
              type="text"
        ...
        <div className="w-full flex pb-3">
          <div className="w-[50%]">
            <label className="block pb-2">Số nhà, đường, phường</label>
            <input
              type="address"
              required
              value={address1}
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Tiền hàng:</h3>
      ...
      <div className="flex justify-between border-b pb-3">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Giảm:</h3>
        <h5 className="text-[18px] font-[600]">
          -{" "}
          {discountPercentenge
            ? discountPercentenge.toLocaleString("vi-VN", {
                style: "currency",
                currency: "VND",
              }) + ""
            : null}
